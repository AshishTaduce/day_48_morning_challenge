...
void sleepForNDuration(int n) {
  print('Begin task $n');
  Future.delayed(Duration(seconds: n), () => 3)  //Returns a value or function callback after the duration.
      .then((n) => print('Completed task $n'));  //.then() uses the return value from the Future.delayed for its defined work.
}
